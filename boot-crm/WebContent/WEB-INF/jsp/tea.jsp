...
<head>
	...
	<title>茶叶信息管理-TeaCRM</title>
	<!-- 引入css样式文件 -->
	<!-- Bootstrap Core CSS -->
	
	<link rel="stylesheet" href="/boot-crm/css/reset.css" />
	<link rel="stylesheet" href="/boot-crm/css/pagination.css" />
...
<div id="wrapper">
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation"
	...
	<div class="navbar-header">
		<a class="navbar-brand" href="<%=basePath%>customer/list.action">Tea客户管理系统 v2.0</a>
	</div>
	<!-- 导航栏右侧图标部分 -->
	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
				...
				<%-- <li>
				    <a href="${pageContext.request.contextPath }/tea/create.action" class="active">
				      <i class="fa fa-edit fa-fw"></i> 茶叶详情
				    </a>
				</li>
				<li>
				    <a href="${pageContext.request.contextPath }/custdata.action">
				      <i class="fa fa-dashboard fa-fw" ></i> 客户资料
				    </a>
				</li>
				 <li>
				    <a href="${pageContext.request.contextPath }/customer/list.action" class="active">
				      <i class="fa fa-edit fa-fw"></i> 客户来源
				    </a>
				</li>
				<li>
				    <a href="#">
				      <i class="fa fa-dashboard fa-fw" ></i> 客户需求
				    </a>
				</li> 
				<li>
				    <a href="#">
				      <i class="fa fa-dashboard fa-fw" ></i> 文件上传
				    </a>
				    <br>
				    
				    <h4 align="center">文件上传专栏</h4>
				    <form action="${pageContext.request.contextPath }/fileUpload"
					    method="post" enctype="multipart/form-data" onsubmit="return check()">
						上传者：<input id="name" type="text" name="name" /><br />
						请选择上传的文件：<input id="file" type="file" name="uploadfile" 
...
<!-- 引入js文件 -->
<!-- 分页及跳转 -->
<script type="text/javascript" src="/boot-crm/js/lib/jquery.min.js"></script>
<script type="text/javascript" src="/boot-crm/js/jquery.pagination.js"></script>
<!-- jQuery -->

...
public class UserController{
	...
	/*
	 * @Resource和@Autowired注解都是用来实现依赖注入的。 只是@AutoWried按by
	 * type自动注入，而@Resource默认按byName自动注入。
	 */
	...
	public String register(@RequestParam(required=false, defaultValue="0")
	int flag, Users user, Model model){

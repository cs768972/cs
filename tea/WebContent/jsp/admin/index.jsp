...
<title>安溪茶叶商城后台管理</title>
<link rel="stylesheet" href="resources/css/layui.css">
<script src="resources/js/jquery.1.12.4.min.js"></script>
<script src="resources/js/layui.js"></script>
</head>
<body class="layui-layout-body" style="background-color:	#E1FFFF;">
	<div class="layui-layout layui-layout-admin">
		<div class="layui-header">
			<div class="layui-logo">安溪茶叶商城后台管理</div>
			<!-- 头部区域（可配合layui已有的水平导航） -->
			<ul class="layui-nav layui-layout-left">
				<li class="layui-nav-item"><a href="view/welcome" target="myframe">商城主页</a></li>
			</ul>
		...
		<div class="layui-body">
			<!-- 内容主体区域 -->
			<iframe src="view/welcome" name="myframe" style="width:1500px;height:680px;border: 0;" ></iframe>
		</div>
